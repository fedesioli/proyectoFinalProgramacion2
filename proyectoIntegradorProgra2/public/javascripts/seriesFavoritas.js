    ...
    fetch("https://api.themoviedb.org/3/tv/" + seriesFavoritas[i] + "?api_key=935b83cf932d87a1deec2a0108c3513e&language=en-US")
      ...
      .then(function(data) {
        if (data.poster_path != null) {
          document.querySelector("section.series").innerHTML += "<article class='serie-favorita'><a href='/home/detalle?id=" + data.id + "'><img src='https://image.tmdb.org/t/p/original" + data.poster_path + "' alt=''></a></article>"
        } else {
          document.querySelector("section.series").innerHTML += "<article class='serie-favorita'><a href='/home/detalle?id=" + data.id + "'><img src='/images/poster-default.png' alt=''></a></article>"
        }
      })
  }
